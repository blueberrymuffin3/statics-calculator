...
<main class="container">
  <div class="box" id="info">
    ...
    <p>
      ...
      forces and moments (or "torques") acting on physical systems that are not
      in motion, like a truss bridge. (<a
        href="https://en.wikipedia.org/wiki/Statics"
        target="_blank"
        rel="noopener noreferrer">Wikipedia</a
      >)
    </p>
    <h2 class="is-size-2 has-text-weight-light">
      What does it mean for a structure to be "statically determinate"
    </h2>
    <p>
      A "statically determinate" structure can be solved mathematically using
      statics. If a structure is not "statically determinate" it cannot be
    ...
    <ol class="pl-6">
      ...
      <p>
        Enter the X and Y coordinates of all of the joints in your structure in
        the <em>Position</em> column of the <a href="#joints">joints table</a>.
        <br />
        You can change the names of any joints to match a diagram if you are copying
        the structure from one.
      </p>
      <div class="is-clearfix" />
      <img src="/img/step_2.png" alt="" width="472" height="250" />
      <li class="is-size-4">Create stuctural members or "beams"</li>
      <p>
        Create all of the stuctural members by adding them to the
        <a href="#members">structural members table</a>.
        <br />
        Use the
        <a href="#canvas" on:click={() => (renderMode = "structure")}
          >structure</a
        >
        view to preview what the structure will look like.
      </p>
      <div class="is-clearfix" />
      <img src="/img/step_3.png" alt="" width="472" height="250" />
      <li class="is-size-4">Add supports</li>
      <p>
        Define any supports under the "Support" column of the
        <a href="#joints">joints table</a>.
        <br />
        Most truss bridges have one "roller" support (X:
        <input type="checkbox" disabled />, Y:
        <input type="checkbox" disabled checked />) and one "pin" support (X:
        <input type="checkbox" disabled checked />, Y:
        <input type="checkbox" disabled checked />). All structures must have at
        lease one X support and at least one Y support to be statically
        determinate.
      </p>
      <div class="is-clearfix" />
      ...
      <p>
        The applied loads are the forces that are acting on your structure.
        Enter the X and Y components of all of your loads under the
        <em>Load</em> column of the <a href="#joints">joints table</a>. Enter
        (0, 0) for any joints that are not loaded.
        <br />
        Use the
        <a href="#canvas" on:click={() => (renderMode = "full")}>
          Full Free Body Diagram
        </a>
        view to preview the direction and magnitude of your
        <span style:color={COLOR_APPLIED_FORCE}>applied loads</span><Icon
          path={mdiArrowDownBold}
          color={COLOR_APPLIED_FORCE}
        />. If your structure is statically determinate, the
        <span style:color={COLOR_REACTION_FORCE}>outside reaction forces</span
        ><Icon path={mdiArrowUpBold} color={COLOR_REACTION_FORCE} />
        will also be calculated and displayed, along with the forces acting on each
        member that is under
        <span class="nobr">
          <Icon path={mdiArrowRightBold} color={COLOR_TENSION} /><span
            style:color={COLOR_TENSION}>tension</span
          ><Icon path={mdiArrowLeftBold} color={COLOR_TENSION} />
        </span>
        or
        <span class="nobr">
          <Icon path={mdiArrowLeftBold} color={COLOR_COMPRESSION} /><span
            style:color={COLOR_COMPRESSION}>compression</span
          ><Icon path={mdiArrowRightBold} color={COLOR_COMPRESSION} />
        </span>
      </p>
      <div class="is-clearfix" />
    </ol>
